...
echo CHtml::link('<span class="icon-bin icon-white"></span> Set Maintenance Schedule', Yii::app()->createUrl('equipment/equipmentmaintenance/create',array('item'=>$model->equipmentID,'id'=>$model->ID)), array('class'=>'btn btn-success', 'style'=>'margin: 0.2em 0 0.5em 0; float:right;','title'=>'Set schedule'));
 $this->beginWidget('zii.widgets.CPortlet', array(
...
echo CHtml::link('<span class="icon-bin icon-white"></span> Set Calibration Schedule', Yii::app()->createUrl('equipment/equipmentcalibration/create',array('item'=>$model->equipmentID)), array('class'=>'btn btn-success', 'style'=>'margin: 0.2em 0 0.5em 0; float:right;','title'=>'Set schedule'));
 $this->beginWidget('zii.widgets.CPortlet', array(
